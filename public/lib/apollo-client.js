...
spurious results.`);
  ...
  function readMultipartBody(response, observer) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      var decoder, contentType, delimiter, boundaryVal, boundary, buffer, iterator, running, _e, value, done, chunk, bi, message, i, headers, contentType_1, body, result2, next;
      var _f, _g;
                  ...
                  if (Object.keys(result2).length > 1 || "data" in result2 || "incremental" in result2 || "errors" in result2 || "payload" in result2) {
                    if (isApolloPayloadResult(result2)) {
                      ...
                      if ("errors" in result2) {
                        next = __assign(__assign({}, next), { extensions: __assign(__assign({}, "extensions" in next ? next.extensions : null), (_g = {}, _g[PROTOCOL_ERRORS_SYMBOL] = result2.errors, _g)) });
                      }
...
const client = new ApolloClient({
  ...
  var host = (
    ...
    maybe3(() => window) || // Otherwise, use a dummy host that's local to this module. We used to fall
  ...
  var LocalState = (function() {
    ...
    LocalState2.prototype.resolveDocument = function(document, rootValue, context, variables, fragmentMatcher, onlyRunForcedResolvers) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var mainDefinition, fragments, fragmentMap, selectionsToResolve, definitionOperation, defaultOperationType, _a4, cache, client, execContext, isClientFieldDescendant;
